...
lines(dem[,nb]~depth,type="l",lwd=linesize, col="black")
axis(1,c(log10(50),log10(250),log10(2000)),c("","",""),cex.axis=1)
#axis(1,c(50,ph,1500,3000),c(50,TeX("\\textit{$x_{u}$}"),1500,3000),cex.axis=1)
#axis(2,c(0,15,30),las=1,cex.axis=1)

###################################################################################
#### get biomass
pathname <- file.path(path, "depth_tempscaling_boreal.mat")
databio <- readMat(pathname)
...
###################################################################################
#### get biomass
pathname <- file.path(path, "depth_tempscaling_temperate.mat")
databio <- readMat(pathname)
...
###################################################################################
#### get biomass
pathname <- file.path(path, "depth_tempscaling_tropical.mat")
databio <- readMat(pathname)
...
lines(batpel[,nb]~depth,type="l",lwd=linesize, col="#5c88c5")
lines(dem[,nb]~depth,type="l",lwd=linesize, col="black")
axis(1,c(50,ph,1500,3000),c("","","",""),cex.axis=0.75)
axis(1,c(log10(50),log10(250),log10(2000)),c("50","250","2000"),cex.axis=1.2)
#axis(2,c(0,15,30),las=1,cex.axis=1)
