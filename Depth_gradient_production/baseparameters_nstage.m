...
% stages
%   
param.nstage = nstage; % number of stages predator use 3, 6, 9, etc (prey = 2/3)
...
param.photic = 150; % photic zone boundary
param.mesop  = 250; % depth at which mesopelagic layer starts
...
%
param.Q10 = 1.88;
param.Q10m = 1.88; % 2.35 Petrik et al.
